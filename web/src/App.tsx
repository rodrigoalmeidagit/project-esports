    ...
    <div className='max-w-[1344px] mx-auto my-20 flex flex-col items-center '>
      ...
      <div className="grid grid-cols-6 gap-6 mt-16">
        ...
        <a href="" className='relative rounded-lg overflow-hidden'>
          ...
          <div className="w-full pt-16 pb-4 px-4 bg-game-gradient absolute 
      ...
      <footer className='pt-1 bg-nlw-gradient self-stretch 
        rounded-lg mt-8 overflow-hidden'>
        <div className='bg-[#2A2634] px-8 py-6 flex justify-between items-center'>
          <div>
            <strong className='text-2xl text-white from-black block'>Não encontrou seu duo?</strong>
